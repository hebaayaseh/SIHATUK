...
namespace Sehatak.Application.Interfaces.ApointmentInterface
{
    public interface IAppointment
    {
        ...
        Task<List<GetPatientWaitListDto>> GetPatientsWaitListsAsync(int centerId,int doctorId,DateOnly date);
        Task<GetPatientWaitListDto> GetPatientWaitListsAsync(int centerId, int doctorId, int userId ,DateOnly date);
    }
}
